...
--------------------------------
---@overload fun():Properties
---@overload fun(char, bool:bool, bool:bool):Properties
---@param id char
---@param searchNames bool
---@param recurse bool
---@return Properties
...
--------------------------------
---@overload fun(char, vec4_table):bool
---@overload fun(char, vec3_table):bool
---@param name char
