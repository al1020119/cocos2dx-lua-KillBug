...
--------------------------------
---@overload fun(_ttfConfig, string, int, int):bool
---@overload fun(string, string, float, size_table, int, int):bool
---@param text string
...
--------------------------------
---@overload fun(Texture2D, int, int, int):bool
---@overload fun(string, int, int, int):bool
...
--------------------------------
---@overload fun(Texture2D, int, int, int):Label
---@overload fun(string, int, int, int):Label
---@overload fun(string):Label
---@param charMapFile string
---@param itemWidth int
---@param itemHeight int
---@param startCharMap int
