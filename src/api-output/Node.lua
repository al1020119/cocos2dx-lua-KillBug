...
--------------------------------
---@overload fun(Node, int):Node
---@overload fun(Node):Node
---@overload fun(Node, int, int):Node
---@overload fun(Node, int, string):Node
---@param child Node
...
---@param cascadeOpacityEnabled bool
---@return Node
...
--------------------------------
---@overload fun(Node):AffineTransform
---@overload fun():AffineTransform
---@param ancestor Node
...
--------------------------------
---@overload fun(float, float):Node
---@overload fun(vec2_table):Node
---@param x float
---@param y float
---@return Node
...
--------------------------------
---@overload fun():Node
---@overload fun(Renderer, mat4_table, int):Node
...
---@param cascadeColorEnabled bool
---@return Node
