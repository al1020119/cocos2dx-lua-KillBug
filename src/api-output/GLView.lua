...
---@param #float 
---@return bool
function GLView:setContentScaleFactor(#float) end
...
---@param #bool 
---@return GLView
function GLView:setCursorVisible(#bool) end
...
---@param #float 
---@return GLView
function GLView:setFrameZoomFactor(#float) end
