...
---@field public Physics3DShape Physics3DShape

---@field public Physics3DObject Physics3DObject

---@field public Physics3DRigidBody Physics3DRigidBody

---@field public Physics3DComponent Physics3DComponent

---@field public PhysicsSprite3D PhysicsSprite3D

---@field public Physics3DWorld Physics3DWorld

---@field public Physics3DConstraint Physics3DConstraint

---@field public Physics3DPointToPointConstraint Physics3DPointToPointConstraint

---@field public Physics3DHingeConstraint Physics3DHingeConstraint

---@field public Physics3DSliderConstraint Physics3DSliderConstraint

---@field public Physics3DConeTwistConstraint Physics3DConeTwistConstraint

---@field public Physics3D6DofConstraint Physics3D6DofConstraint

---@field public PhysicsShape PhysicsShape

---@field public PhysicsShapeCircle PhysicsShapeCircle

---@field public PhysicsShapePolygon PhysicsShapePolygon

---@field public PhysicsShapeBox PhysicsShapeBox

---@field public PhysicsShapeEdgeSegment PhysicsShapeEdgeSegment

---@field public PhysicsShapeEdgePolygon PhysicsShapeEdgePolygon

---@field public PhysicsShapeEdgeBox PhysicsShapeEdgeBox

---@field public PhysicsShapeEdgeChain PhysicsShapeEdgeChain

---@field public PhysicsBody PhysicsBody

---@field public PhysicsContact PhysicsContact

---@field public PhysicsContactPreSolve PhysicsContactPreSolve

---@field public PhysicsContactPostSolve PhysicsContactPostSolve

---@field public EventListenerPhysicsContact EventListenerPhysicsContact

---@field public EventListenerPhysicsContactWithBodies EventListenerPhysicsContactWithBodies

---@field public EventListenerPhysicsContactWithShapes EventListenerPhysicsContactWithShapes

---@field public EventListenerPhysicsContactWithGroup EventListenerPhysicsContactWithGroup

---@field public PhysicsJoint PhysicsJoint

---@field public PhysicsJointFixed PhysicsJointFixed

---@field public PhysicsJointLimit PhysicsJointLimit

---@field public PhysicsJointPin PhysicsJointPin

---@field public PhysicsJointDistance PhysicsJointDistance

---@field public PhysicsJointSpring PhysicsJointSpring

---@field public PhysicsJointGroove PhysicsJointGroove

---@field public PhysicsJointRotarySpring PhysicsJointRotarySpring

---@field public PhysicsJointRotaryLimit PhysicsJointRotaryLimit

---@field public PhysicsJointRatchet PhysicsJointRatchet

---@field public PhysicsJointGear PhysicsJointGear

---@field public PhysicsJointMotor PhysicsJointMotor

---@field public PhysicsWorld PhysicsWorld
