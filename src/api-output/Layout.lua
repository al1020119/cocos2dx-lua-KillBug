...
--------------------------------
---@overload fun(color3b_table, color3b_table):Layout
---@overload fun(color3b_table):Layout
...
--------------------------------
---@overload fun(Node, int):Layout
---@overload fun(Node):Layout
---@overload fun(Node, int, int):Layout
---@overload fun(Node, int, string):Layout
---@param child Node
