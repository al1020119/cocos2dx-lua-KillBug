ccui = ccui or {}
---Scale9Sprite object
---@class Scale9Sprite : Sprite
local Scale9Sprite = {}
ccui.Scale9Sprite = Scale9Sprite

--------------------------------
---@overload fun(Sprite, rect_table, bool:bool, vec2_table, size_table, rect_table):bool
---@overload fun(Sprite, rect_table, bool:bool, rect_table):bool
---@param sprite Sprite
---@param rect 
---@param rotated bool
...
--------------------------------
---@overload fun(Sprite, rect_table, rect_table):bool
---@overload fun(Sprite, rect_table, bool:bool, rect_table):bool
---@overload fun(Sprite, rect_table, bool:bool, vec2_table, size_table, rect_table):bool
---@param sprite Sprite
---@param rect 
...
--------------------------------
---@overload fun(rect_table, string):bool
---@overload fun(string, rect_table, rect_table):bool
---@param file string
---@param rect 
---@param capInsets rect_table
---@return bool
...
--------------------------------
---@overload fun(string, rect_table, rect_table):Scale9Sprite
---@overload fun():Scale9Sprite
---@overload fun(rect_table, string):Scale9Sprite
---@overload fun(string, rect_table):Scale9Sprite
---@overload fun(string):Scale9Sprite
---@param file string
---@param rect 
---@param capInsets rect_table
---@return Scale9Sprite
...
--------------------------------
---@overload fun(SpriteFrame, rect_table):Scale9Sprite
---@overload fun(SpriteFrame):Scale9Sprite
---@param spriteFrame SpriteFrame
---@param capInsets rect_table
---@return Scale9Sprite
