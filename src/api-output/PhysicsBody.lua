...
--------------------------------
---@overload fun(int, bool:bool):PhysicsBody
---@overload fun(PhysicsShape, bool:bool):PhysicsBody
---@param shape PhysicsShape
---@param reduceMassAndMoment bool
---@return PhysicsBody
...
--------------------------------
---@overload fun(float):PhysicsBody
---@overload fun():PhysicsBody
---@overload fun(float, float):PhysicsBody
---@param mass float
---@param moment float
---@return PhysicsBody
