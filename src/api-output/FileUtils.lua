...
--------------------------------
---@overload fun(string, function):FileUtils
---@overload fun(string):FileUtils
---@param path string
...
--------------------------------
---@overload fun(string, string, string, function):FileUtils
---@overload fun(string, string, string):FileUtils
---@overload fun(string, string):FileUtils
---@overload fun(string, string, function):FileUtils
---@param path string
...
--------------------------------
---@overload fun(array_table, string, function):FileUtils
---@overload fun(array_table, string):FileUtils
...
--------------------------------
---@overload fun(map_table, string, function):FileUtils
---@overload fun(map_table, string):FileUtils
---@param dict map_table
---@param fullPath string
---@param callback function
---@return FileUtils
